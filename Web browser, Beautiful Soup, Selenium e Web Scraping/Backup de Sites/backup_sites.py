...
#faz backup de todas as paginas de um site.
...
os.chdir('C:\\Matheus\\Study\\IT\\Python\\' + os.path.basename(url))
print(os.getcwd())

url_list = web_ulr.findall(page.text)
...
for link in url_list:
    try:
        ...
        file_name = os.path.basename(link) + '.html'
        object_imagem_file = open(file_name, 'wb')
