...
#im_feelling_lucky_google.py

#O programa deve abrir todas mas princiapais pagina que aparece em uma busca no google.

#TODO:Ler os argumentos da linha de comandos.
#TODO: FAZER UMA LISTA DE SITES ENCONTRADOS E ATRIBUILOS EM UMA LISTA E DEPOIS ABRLOS EM UM LOOPING FOR.
...
if len(sys.argv) == 1:
    print('O arquivo im_feelling_lucky_google.py possui apenas um argumento. Tente novamente.')

elif len(sys.argv) == 2:
    print('Googling...')
    #Exibe este print como se tivesse carregando.

    object_response_requests = requests.get('https://google.com/search?q=' + ' '.join(sys.argv[1:]))
